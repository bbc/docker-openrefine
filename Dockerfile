...
ADD https://github.com/OpenRefine/OpenRefine/releases/download/2.6-rc.2/openrefine-linux-2.6-rc.2.tar.gz ./
RUN tar -xvf openrefine-linux-2.6-rc.2.tar.gz
RUN mv openrefine-2.6-rc.2/ OpenRefine

# Add and unzip DERI RDF Extension v0.8.0
RUN apt-get install unzip
ADD https://github.com/fadmaa/grefine-rdf-extension/releases/download/v0.9.0/orefine-rdf-extension-0.9.zip /OpenRefine/webapp/extensions/
RUN cd /OpenRefine/webapp/extensions ; \
    unzip orefine-rdf-extension-0.9.zip ; \
    mv orefine-rdf-extension-0.9 rdf-extension
